...
ADD EVENT sqlserver.sp_statement_completed(
    ...
    WHERE (
			[sqlserver].[database_id]=(34)
		and	writes>0
	and object_name <> 'USER_SP_SOMETHING_CALCULATE'
	and object_name <> 'USER_SP_SOMETHING_CALCULATE_AREA'
	and object_name <> 'USER_SP_SOMETHING_CALCULATE_AREA_template'
...
ADD TARGET package0.asynchronous_file_target(
				SET filename=		N'd:\temp\MSSQL_Event_Session_Logs\AwesomeSystemV0_session.xel'
				,	metadatafile=	N'd:\temp\MSSQL_Event_Session_Logs\AwesomeSystemV0_session.xem'
				,	max_file_size=(100)
)
WITH (
	MAX_MEMORY=64MB
