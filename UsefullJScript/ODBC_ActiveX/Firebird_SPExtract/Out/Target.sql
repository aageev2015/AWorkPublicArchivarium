...
BEGIN
    ...
    BEGIN
        ...
        :"AdminUnitID", :"ANewAccessLevel", GETUTCDATE(),
        :"CurrentAdminUnitID", GETUTCDATE(), :"CurrentAdminUnitID");
    END ELSE
    BEGIN
...
returns (
    ...
    "TimeZone" varchar(250) character set unicode_fss)
as
BEGIN
...
BEGIN
    ...
    */
    ...
    BEGIN
        ...
        SET "UserPasswordChangedOn" = GETUTCDATE()
